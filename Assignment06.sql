...
-- 2021-11-21,SamChen,Created File
-- 2021-11-22,SamChen,Completed Q1-Q7
-- 2021-11-23,SamChen,Completed Q8-Q10; Edited Q3-Q7
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_SamChen')
	 Begin 
	  Alter Database [Assignment06DB_SamChen] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_SamChen;
	 End
	Create Database Assignment06DB_SamChen;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_SamChen;
...
AS
	...
	INNER JOIN vEmployees AS E ON M.EmployeeID = E.ManagerID
...
-- Here are the rows selected from the view:W
-- Manager	        Employee
